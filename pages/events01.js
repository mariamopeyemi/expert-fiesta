...
export default function Events() {
  ...
  // const slides = ['/img/bg-nude.png', '/img/img1.svg'];
          ...
          <Carousel 
              ...
              >
                    {slides?.map((item, i) => {
                      return (
                        ...
                        // className='!w-[100vw] h-[450px] mx-[2rem]  '
             ...
             <section className="flex gap-[1rem] flex-col md:flex-row justify-between">
              <div className="flex flex-col gap-[1rem]">
                <p className="display_4">Drip Party</p>
                <p className="sub_display_2">Nike Lake Resort, April 9, 2023</p>
              </div>
              ...
              <div className="flex gap-[6rem] md:flex-row">
                <div className="flex flex-col md:flex-row gap-[2rem] md:items-center ">
                  ...
                  <div>
                    ...
                    <p className="sub_display_4">Sat, April 9, 2023, 6:00pm</p>
                  </div>
                </div>
                <div className="flex flex-col md:flex-row gap-[2rem] md:items-cente ">
                  ...
                  <div>
                    ...
                    <p className="sub_display_4">Nike Lake Resort, Enugu, Nigeria</p>
                  </div>
                </div>
              </div>
            </div>
